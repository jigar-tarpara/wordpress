					...
					<div class="xlarge-8 large-10 xlarge-centered large-centered columns without-sidebar">
						...
						if( is_home() && get_option('page_for_posts') ) {
							if ( (isset($page_title_option)) && ($page_title_option == "on") ) {
								...
								#echo '<p class="copy">'. _e('(Alle Artikel mit 3-5 Min. Lesezeit)', 'shopkeeper'); .'</p>';
								echo '<p class="copy" style="text-align:center;">'; 
								_e('In 3-5 Min. pro Artikel erf&auml;hrst du alles zu den Themen Abnehm-Rezepte sowie wertvolle<br/>Alltags-Tipps und -Tricks zum Thema gesunde Di&auml;t und Abnehmen.', 'shopkeeper');
								echo '</p>';
							}
						}
						?>
