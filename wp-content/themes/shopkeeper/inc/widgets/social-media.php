...
class Social_Media_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( $facebook ) echo('<a href="' . $facebook . '" rel="nofollow" target="_blank" class="widget_connect_facebook">Facebook</a>' );
		if ( $pinterest ) echo('<a href="' . $pinterest . '" rel="nofollow" target="_blank" class="widget_connect_pinterest">Pinterest</a>' );
		if ( $linkedin ) echo('<a href="' . $linkedin . '" rel="nofollow" target="_blank" class="widget_connect_linkedin">Linkedin</a>' );
		if ( $twitter ) echo('<a href="' . $twitter . '" rel="nofollow" target="_blank" class="widget_connect_twitter">Twitter</a>' );
		if ( $googleplus ) echo('<a href="' . $googleplus . '" rel="nofollow" target="_blank" class="widget_connect_googleplus">Google+</a>' );
		if ( $rss ) echo('<a href="' . $rss . '" rel="nofollow" target="_blank" class="widget_connect_rss">RSS</a>' );
		if ( $tumblr ) echo('<a href="' . $tumblr . '" rel="nofollow" target="_blank" class="widget_connect_tumblr">Tumblr</a>' );
		if ( $instagram ) echo('<a href="' . $instagram . '" rel="nofollow" target="_blank" class="widget_connect_instagram">Instagram</a>' );
		if ( $youtube ) echo('<a href="' . $youtube . '" rel="nofollow" target="_blank" class="widget_connect_youtube">Youtube</a>' );
		if ( $vimeo ) echo('<a href="' . $vimeo . '" rel="nofollow" target="_blank" class="widget_connect_vimeo">Vimeo</a>' );
		if ( $behance ) echo('<a href="' . $behance . '" rel="nofollow" target="_blank" class="widget_connect_behance">Behance</a>' );
		if ( $dribble ) echo('<a href="' . $dribble . '" rel="nofollow" target="_blank" class="widget_connect_dribble">Dribble</a>' );
		if ( $flickr ) echo('<a href="' . $flickr . '" rel="nofollow" target="_blank" class="widget_connect_flickr">Flickr</a>' );
		if ( $git ) echo('<a href="' . $git . '" rel="nofollow" target="_blank" class="widget_connect_git">Git</a>' );
		if ( $skype ) echo('<a href="' . $skype . '" rel="nofollow" target="_blank" class="widget_connect_skype">Skype</a>' );
		if ( $weibo ) echo('<a href="' . $weibo . '" rel="nofollow" target="_blank" class="widget_connect_weibo">Weibo</a>' );
		if ( $foursquare ) echo('<a href="' . $foursquare . '" rel="nofollow" target="_blank" class="widget_connect_foursquare">Foursquare</a>' );
		if ( $soundcloud ) echo('<a href="' . $soundcloud . '" rel="nofollow" target="_blank" class="widget_connect_soundcloud">Soundcloud</a>' );
		if ( $vk ) echo('<a href="' . $vk . '" rel="nofollow" target="_blank" class="widget_connect_vk">VK</a>' );
